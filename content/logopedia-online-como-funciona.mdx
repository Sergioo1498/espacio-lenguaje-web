...
> **Material para las tareas entre sesiones.** El [Cuaderno de Estimulación 3-6 años](/recursos/cuaderno-3-6) y el [Pack Completo](/recursos/pack-completo) están pensados para imprimir y usar en casa entre una sesión y la siguiente.
...
> **¿Quieres un punto de partida claro antes de decidir?** Descarga gratis nuestra [guía de hitos del lenguaje 0-6 años](/lp/guia-gratis) — 11 páginas revisadas por logopeda colegiada con los hitos esperables a cada edad y señales de alerta para saber si tu peque necesita valoración. Si buscas material estructurado, en [/recursos](/recursos) tienes cuadernos diseñados por logopedas.
