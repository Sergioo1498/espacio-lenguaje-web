...
- **Es hereditaria**. Si un padre o madre tiene dislexia, hay una probabilidad significativamente mayor de que sus hijos también la presenten.
...
En esta etapa aún no se puede diagnosticar dislexia como tal, pero sí identificar **factores de riesgo**. Para entender qué es lo esperable a cada edad, te recomendamos revisar las [etapas del desarrollo del lenguaje](/blog/etapas-desarrollo-del-lenguaje):
...
La intervención temprana en dislexia tiene un impacto enorme. Los estudios muestran que los niños que reciben apoyo especializado antes de los 7-8 años tienen resultados significativamente mejores que los que empiezan más tarde.
...
> **¿Quieres una guía específica para trabajar la dislexia en casa?** En la [sección de recursos](/recursos) encontrarás la **Guía de Dislexia** con actividades multisensoriales, pautas para el cole y un plan semanal de ejercicios. Y si aún no sabes si las dificultades de tu peque encajan con la dislexia, descarga gratis nuestra [guía de hitos del lenguaje](/lp/guia-gratis) para situarte.
