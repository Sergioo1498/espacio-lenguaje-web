...
Aquí te proponemos cinco ejercicios que puedes empezar a hacer hoy mismo. Cada uno trabaja un aspecto diferente del lenguaje y están pensados para adaptarse a distintas edades.
...
Muchos sonidos del habla (como la /s/, la /f/, la /ch/ o la /r/) requieren un flujo de aire bien dirigido y controlado. Los ejercicios de soplo fortalecen los músculos de los labios y las mejillas, y enseñan al niño a controlar la presión y dirección del aire. Son ejercicios que los logopedas incluyen frecuentemente en las sesiones de terapia miofuncional.
