...
fs.writeFileSync('pinterest/CALENDARIO.md',`# Calendario propuesto — pendiente de fecha de arranque\n\nInicio orientativo: ${start}. No se ha programado ni publicado nada. Horas Europe/Madrid; CSV Pinterest convertido a UTC, incluido el cambio de hora del 25 de octubre. Continuidad: 5/semana durante 4 semanas.\n\n| Nº | Título | Board | Fecha Madrid | Enlace UTM | Imagen |\n|---|---|---|---|---|---|\n`+pins.map(p=>`| ${p.id} | ${p.title} | ${p.board} | ${p.date} ${p.time} | [Página](${p.link}) | [PNG](${p.imageUrl}) |`).join('\n'));
