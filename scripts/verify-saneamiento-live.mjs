...
assert(pdfs.find(p=>p.name==='guia-dislexia.pdf').unchangedSinceBaseline);
assert(catalog.every(p=>p.status===200&&!p.missing.length),'Catalog claims do not match');
